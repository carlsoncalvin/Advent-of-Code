...
def solve_part2(lines: list[str]) -> int:
    ...
    return total
# I realized after the fact that I don't have to go from right to left when joining the stacks,
# but I think I'll just leave the code how it is. For posterity.
